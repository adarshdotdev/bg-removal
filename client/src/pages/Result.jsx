            ...
            <div className='bg-white rounded-lg px-8 py-6 drop-shadow-sm'>
                ...
                <div className='flex flex-col sm:grid grid-cols-2 gap-8'>
                    ...
                    <div>
                        ...
                        <img className='rounded-md border' src={image ? URL.createObjectURL(image) : ""} alt="image-w-bg" />
                    </div>
                    {/* ------------ Right Side ----------- */}
                    <div className='flex flex-col'>
                        <p className='font-semibold text-gray-600 mb-2'>Background Removed</p>
                        <div className='rounded-md border border-gray-300 h-full relative bg-layer overflow-hidden'>
                            <img src={resultImage ? resultImage : ""} alt="image_wo_bg" />
                            {
                ...
                {resultImage && (<div className='flex justify-center sm:justify-end items-center flex-wrap gap-4 mt-6'>
                    <button onClick={() => navigate("/")} className='px-8 py-2.5 text-violet-600 text-sm border border-violet-600 rounded-full hover:scale-105 transition-all duration-700'>Try anther image</button>
