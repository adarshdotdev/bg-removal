    ...
    return (
        <div className='flex items-center justify-center max-sm:flex-col-reverse gap-y-10 px-4 mt-10 lg:px-44 sm:mt-20'>
            ...
            <div  >
                ...
                <p className='my-6 text-[15px] text-gray-500'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptatibus, wow!  <br className='max-sm:hidden' /> Lorem ipsum dolor sit amet consectetur adipisicing elit.  error!</p>
                <div>
                    <input onChange={(e) => removeBg(e.target.files[0])} type="file" id="upload1" accept='image/*'
                        hidden />
